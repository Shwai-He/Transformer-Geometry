...
export RUN_IN_BACKGROUND="${RUN_IN_BACKGROUND:-false}"
...
bash "$SCRIPT_DIR/train_xsa_forward_value_preproj.sh" "$SCRIPT_DIR/../config/train_xsa_0p7b.py"
