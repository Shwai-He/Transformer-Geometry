...
SETTINGS=(
  "wanda_24_local|pruned|prune|wanda_2_4|local|*|/path/to/resource|-|0|false"
  "wanda_48_local|pruned|prune|wanda_4_8|local|*|/path/to/resource|-|0|false"
  "wanda_unstructured_local|pruned|prune|wanda_unstructured|local|*|/path/to/resource|-|0|false"
  "awq_local|pruned|quant|awq_native|local|*|/path/to/resource|-|0|true"
